...
//header file which includes all the header files and fuction definitions
void startquiz()
	{
...
system("cls");
     ...
     printf("\n\t\t________________________________________");
     printf("\n\t\t________________________________________");
     printf("\n\t\t   WIN A GAME AND GET ADMISSION IN HOGWARTS!!!!!!!!!!!    ") ;
     printf("\n\t\t________________________________________");
     printf("\n\t\t________________________________________");
    ...
    switch(choice)
    {
    	case 1:startquiz();//start the quiz
    	       break;
        case 2:help();// To read the instruction 
		       getch();
           
        case 3:exit(1);// To quit the game
               break;
	}
